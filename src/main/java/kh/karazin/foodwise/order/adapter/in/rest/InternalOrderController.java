...
/**
 * Internal REST adapter for inter-service communication.
 */
@RestController
...
public class InternalOrderController {
    ...
    public ResponseEntity<ApiResponse<OrderDto>> getOrderById(@PathVariable UUID orderId) {
        ...
        // public gateway. See ADR 0004 and OrderUseCase.getUnscoped.
        var order = orderUseCase.getUnscoped(new OrderId(orderId));
